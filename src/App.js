...
const users = { 
  1: { id: 1, name: "Jane Cruz", userName: "coder" }, 
...
const contacts = [ 
  { "id": "karen", "name": "Karen Isgrigg", "handle": "karen_isgrigg", "avatarURL": "https://www.gravatar.com/avatar/205e460b479e2e5b48aec07710c08d50"

}, 
{ "id": "richard", "name": "Richard Kalehoff", "handle": "richardkalehoff", "avatarURL": "https://www.gravatar.com/avatar/205e460b479e2e5b48aec07710c08d50" }, 
{ "id": "tyler", "name": "Tyler McGinnis", "handle": "tylermcginnis", "avatarURL": "https://www.gravatar.com/avatar/205e460b479e2e5b48aec07710c08d50" } ];
...
const addContact = (contact) => {
  ...
  return (
    ...
    <Routes>
      <Route path='/' element={<ListContacts  contacts={state.contacts} 
...
/*
<Routes>
<Route path='/' element={<ListContacts contacts={state.contacts} onDeleteContact={removeContact}/>  }/>
